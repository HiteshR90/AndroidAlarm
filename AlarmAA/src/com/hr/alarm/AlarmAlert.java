...
import com.hr.hardware.ShakeListener;
...
public class AlarmAlert extends Activity implements Alarms.AlarmSettings {
    ...
    private void updateLayout() {
        setContentView(R.layout.math_captcha);
...
//        }
        ...
        mSnoozeButton = (Button) findViewById(R.id.btn_addtwonumbers_snooze);
        if (mSnooze > 0) {
        ...
        final TextView txtadd=(TextView) findViewById(R.id.txtadd1);
        final TextView txteq=(TextView) findViewById(R.id.txtequl);
