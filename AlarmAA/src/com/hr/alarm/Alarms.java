...
public class Alarms {
    ...
    public final static String ALARM_ALERT_ACTION = "com.hr.alarm.ALARM_ALERT";
    ...
    static class DaysOfWeek {
        ...
        public String toString(Context context, boolean showNever) {
            ...
            CharSequence[] strings =
                    context.getResources().getTextArray((dayCount > 1) ? R.array.days_of_week_short :R.array.days_of_week1);
        ...
        public boolean isSet(int day) {
        	boolean i=(mDays & (1 << day)) > 0;
            return ((mDays & (1 << day)) > 0);
        }

        public void set(int day, boolean set,int f) {
    ...
    public static class AlarmColumns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
            Uri.parse("content://com.hr.alarm/alarm");
        ...
        public static final String RINGBACK = "ringbackground";
        ...
        static final String[] ALARM_QUERY_COLUMNS = {
            ...
            SNOOZE, ALARMTYPE, RINGBACK, VIBRATE_ONLY, VOLUME, ALERTTYPE,
        ...
        public static final int ALARM_ALARMTYPE_INDEX = 10;
        public static final int ALARM_RINGBACK_INDEX = 11;
        public static final int ALARM_VIBRATE_ONLY_INDEX = 12;
        public static final int ALARM_VOLUME_INDEX = 13;
        public static final int ALARM_ALERTTYPE_INDEX = 14;
    ...
    static interface AlarmSettings {
        void reportAlarm(
          ...
          int snooze, String alarmtype, String ringback, boolean vibrate_only, int volume, String alerttype,
    ...
    public synchronized static Uri addAlarm(Context context) {
        ...
        values.put(Alarms.AlarmColumns.ALARMTYPE, prefs.getInt("default_duration", 10));
       // values.put(Alarms.AlarmColumns., prefs.getInt("default_delay", 0));
    ...
    private synchronized static void getAlarms(
        ...
        if (cur.moveToFirst()) {
            do {
                ...
                String alarmtype = cur.getString(AlarmColumns.ALARM_ALARMTYPE_INDEX);
                String  ringback= cur.getString(AlarmColumns.ALARM_RINGBACK_INDEX);
                ...
                String alerttype = cur.getString(AlarmColumns.ALARM_ALERT_INDEX);
    ...
    public synchronized static void setAlarm(
        ...
        values.put(AlarmColumns.ALARMTYPE, alarmtype);
        values.put(AlarmColumns.RINGBACK, ringback);
        values.put(AlarmColumns.VIBRATE_ONLY, vibrate_only);
        values.put(AlarmColumns.VOLUME, volume);
        values.put(AlarmColumns.ALERTTYPE, alerttype);
    ...
    private synchronized static void enableAlarmInternal(
        ...
        class EnableAlarm implements AlarmSettings {
            ...
            public void reportAlarm(
                    int idx, boolean enabled, int hour, int minutes,
                    DaysOfWeek daysOfWeek, boolean vibrate, String message, String alert,
                    int snooze, String alrmtype, String ringback, boolean vibrate_only, 
                    int volume, String alerttype,
                    int captcha_snooze, int captcha_dismiss
                    ) {
                mHour = hour;
                mMinutes = minutes;
    ...
    static class AlarmCalculator implements AlarmSettings {
        ...
        public void reportAlarm(
                int idx, boolean enabled, int hour, int minutes,
                DaysOfWeek daysOfWeek, boolean vibrate, String message, String alert,
                int snooze, String alarmtype, String ringback, boolean vibrate_only, 
                int volume, String alerttype,
                int captcha_snooze, int captcha_dismiss
                ) {
            if (enabled) {
